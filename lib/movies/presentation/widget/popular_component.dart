...
class PopularMovieComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  BlocBuilder<MovieBloc,MoviesState>(
        buildWhen: (previous,current)=>previous.nowpopuler!=current.nowpopuler,
        builder:(context,state)
    {
      switch (state.nowpopuler) {
          ...
          return FadeIn(
            ...
            child: SizedBox(
              ...
              child: ListView.builder(
                ...
                itemCount: state.nowpopulermovies.length,
                itemBuilder: (context, index) {
                  final movie = state.nowpopulermovies[index];
                  return Container(
