...
import '../../domain/eintites/geners.dart';
...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context)=>sl<MovieDetailsBloc>()..add(GetMovieDetailsEvent(id))..add(GetMovieRecommdentionEvent(id)),
      child: Scaffold(
                    ...
                    background: FadeIn(
                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl: AppConstant.imageurl(state.movieDetails!.backdropPath),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            'Genres: ${_showGenres(state.movieDetails!.genreIds)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
      ...
      builder: (context,state)
      {
        ...
        return SliverGrid(
          delegate: SliverChildBuilderDelegate(
                (context, index) {
              final recommendation =state.movierecommdention[index];
              return FadeInUp(
                from: 20,
                duration: const Duration(milliseconds: 500),
                child: ClipRRect(
            ...
            childCount: state.movierecommdention.length,
          ),
